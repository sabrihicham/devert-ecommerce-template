...
function productValues(data: Partial<InsertProduct>) {
  return {
    ...(data.name !== undefined && { name: data.name }), ...(data.description !== undefined && { description: data.description }), ...(data.brand !== undefined && { brand: data.brand }), ...(data.ingredients !== undefined && { ingredients: data.ingredients }), ...(data.usage !== undefined && { usage: data.usage }), ...(data.warnings !== undefined && { warnings: data.warnings }), ...(data.tags !== undefined && { tags: data.tags }), ...(data.price !== undefined && { price: String(data.price) }), ...(data.compareAtPrice !== undefined && { compareAtPrice: data.compareAtPrice == null ? null : String(data.compareAtPrice) }), ...(data.category !== undefined && { category: data.category }), ...(data.img !== undefined && { img: data.img }), ...(data.isFeatured !== undefined && { isFeatured: data.isFeatured }), ...(data.isBestSeller !== undefined && { isBestSeller: data.isBestSeller }), ...(data.isNewArrival !== undefined && { isNewArrival: data.isNewArrival }), ...(data.stock !== undefined && { stock: data.stock }), ...(data.status !== undefined && { status: data.status }),
  };
}

function variantValues(v: z.infer<typeof variantInput>, productId: number) {
  return { productId, flavor: v.flavor, form: v.form as any, quantity: String(v.quantity), quantityUnit: v.quantityUnit as any, servings: v.servings ?? null, sku: v.sku, price: String(v.price), compareAtPrice: v.compareAtPrice == null ? null : String(v.compareAtPrice), stock: v.stock, images: v.images, isActive: v.isActive };
}
